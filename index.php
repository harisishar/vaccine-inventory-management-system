				  ...
				  <div id="vendorDetailsMessage"></div>
					 <form> 
					  ...
					  <div class="form-row">
						...
						<div class="form-group col-md-4">
						  <label for="vendorDetailsVendorState">State</label>
						  <select id="vendorDetailsVendorState" name="vendorDetailsVendorState" class="form-control chosenSelect">
							<?php include('inc/stateList.html'); ?>
						  </select>
						</div>
					  </div>					  
